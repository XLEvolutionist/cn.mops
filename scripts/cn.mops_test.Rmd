...
date
```
On setting of the cn.mops run I discovered that the reference sequence that was used by Vince to map the first teosinte lines was not the same as I had used to map TIL01. This means I will have to re-map to the same reference sequence. This is achieved via a very similar script as above but pointing to a different refernce:
